...
export function processInput(input: unknown): string | number | MessageObject | undefined {
...
export function processVehicle(vehicle: Car | Bike): string | undefined {
 ...
 */
export function processUser(user: User | Admin): string | undefined {
